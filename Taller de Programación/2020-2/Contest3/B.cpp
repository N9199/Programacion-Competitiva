...
int main()
{
    ...
    int q;
    cin >> q;
    WaveTree wt(next, n+1);
    int i, j;
    rep(_, q)
    {
        cin >> i >> j;
        i--;
        cout << wt.range(j, n, i, j) << '\n';
    }
}
...
// a = [1,2,3,2,1,2,3,5] -> a' = [1,2,3,2,2,2,3,5]
// a = [0,1,2,3,4,5,6,7]
// len(a) = 8
// next[i] = "siguiente indice donde aparece el elemento a[i]"* que si no hay siguiente se pone len(a) (8)
// next = [4,3,6,5,(8,6),8,8,8]
// query l,r se ve la query range(l,r,r+1,len(a))
